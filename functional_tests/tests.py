...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        # item. Ela insere "Use peacock feather to make a fly" (Usar penas de pavão
        ...
        # Então ela acessa esse URL - sua lista de tarefas continua lá.

        # Satisfeita, ela volta a dormir.

    def test_multiple_users_can_start_lists_at_differente_urls(self):
    ...
    def test_layout_and_styling(self):
        ...
        # Ela inicia uma lista nova e vê que a entrada está elegantemente
